...
const BillingIntegration: React.FC<BillingIntegrationProps> = ({ isConnected, setConnected }) => {
    return (
        <div className="space-y-6">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Billing Integration</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Connect your Stripe account to accept payments from your clients directly through AdaptiveCRM invoices.</p>
                ...
                {isConnected ? (
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Account: billing@adaptivesolutions.dev</p>
                        </div>
                     ...
                     <div className="text-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 mb-4">Click the button below to connect your Stripe account.</p>
